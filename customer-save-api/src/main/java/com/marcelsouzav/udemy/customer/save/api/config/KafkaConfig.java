package com.marcelsouzav.udemy.customer.save.api.config;
...
public class KafkaConfig {
    ...
    @Value("${kafka.bootstrap-servers}") //Servidor - aonde que está o kafka
    private String bootstrapServers;

    @Value("${kafka.topic.requestreply-topic}")//o topico que estou enviando mensagem  - requesttopic2
